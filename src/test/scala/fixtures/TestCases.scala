...
object TestCases {
  lazy val testCases: List[TestCase] = List(
    TestCase("MARTHA", "MARHTA", Some(0.944), Some(0.961), Some(0.667), Some(2), Some(0.4),
      ngram = Some(1), longestCommonSeq = Some(5), overlap = Some(1),
    ...
    TestCase("karolin", "kathrin", hamming = Some(0.571), hammingDist = Some(3),
      ngram = Some(0.714), overlap = Some(0.714), nGramDist = Some(5)),
    ...
    TestCase("night", "nact", Some(0.633), Some(0.67), Some(0.4), Some(3), ngram = Some(0.4),
    ...
    TestCase("", "", Some(1), Some(1), Some(1), Some(0), Some(1), Some(1), ngram = Some(1), nGramDist = Some(0))
  )
